...
#SBATCH -A m2621
#SBATCH --mem=40GB
#SBATCH -o /global/cscratch1/sd/wzhang5/data/miqs/o%j.insert_index_102
#SBATCH -e /global/cscratch1/sd/wzhang5/data/miqs/o%j.insert_index_102
...
ATTRNUM=16
PERSISTENCE_TYPE=1
INDEX_DIR=/global/cscratch1/sd/wzhang5/data/miqs/idx102
