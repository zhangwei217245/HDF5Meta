...
#SBATCH -A m2621
#SBATCH --mem=40GB
#SBATCH -o /global/cscratch1/sd/wzhang5/data/miqs/o%j.insert_index_84
#SBATCH -e /global/cscratch1/sd/wzhang5/data/miqs/o%j.insert_index_84
...
ATTRNUM=16
PERSISTENCE_TYPE=2
INDEX_DIR=/global/cscratch1/sd/wzhang5/data/miqs/idx84
