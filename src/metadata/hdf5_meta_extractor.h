 ...
 * 
 * @param file_path            the path of HDF5 file
 * @param meta_collector       the metadata collector 'object' including data field and action method. 
 * @param is_visit_link        specifying if the HDF5 link should be visited and followed.
 */
