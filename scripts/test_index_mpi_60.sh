...
#SBATCH -A m2621
#SBATCH --mem=40GB
#SBATCH -o /global/cscratch1/sd/wzhang5/data/miqs/o%j.insert_index_64
#SBATCH -e /global/cscratch1/sd/wzhang5/data/miqs/o%j.insert_index_64
...
ATTRNUM=16
PERSISTENCE_TYPE=2
INDEX_DIR=/global/cscratch1/sd/wzhang5/data/miqs/idx64
